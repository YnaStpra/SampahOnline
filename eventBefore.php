...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" id="penanda" href="eventBefore.php">Event<span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
  ...
  <!-- JUMBOTRON -->
  <div class="jumbotron jumbotron-fluid" style="background: url('img/2.png'); background-repeat: no-repeat;">
    <div class="container">
