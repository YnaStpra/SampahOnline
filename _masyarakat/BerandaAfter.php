        ...
        <div class="carousel-item active">
          ...
          <div class="container">
            <div class="carousel-caption text-left">
              ...
              <p><a class="btn btn-lg btn-edit" href="about-us.php" role="button">Tentang Bang Sampah</a></p>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-edit" href="tukar-sampah.php" role="button">Tukar sekarang</a></p>
            </div>
          </div>
        </div>
        <div class="carousel-item">
    ...
    <section class="event" id="event">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="mx-auto wid-30 text-center"> <a href="event.php" class="btn btn-edit wid">Lihat Lainnya</a> </div>
        </div>
      </div>
    </section>
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-lg-6 pl-70">
              ...
              <a href="tukar-sampah.php" class="btn btn-edit">Yuk Tukar Sampah!</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="artikel" id="artikel">
      <div class="container">
        ...
        <div class="row">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="pr-15">
                      <a href="rincian-artikel.php?kd_artikel=<?= isset($row['kd_artikel']) ? $row['kd_artikel'] : '' ?>" class="btn btn-edit">Selengkapnya</a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          ?>
          <div class="mx-auto wid-30 text-center"> <a href="artikel.php" class="btn btn-edit wid">Lihat Lainnya</a> </div>
