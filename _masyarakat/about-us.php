...
<head>
  ...
  <title>Tentang kami | BANG SAMPAH</title>
        ...
        <div class="fdb-box">
          <div class="row">
            ...
            <div class="col-md-8 mt-4 mt-md-0">
              <p class="lead">
                "Menjadikan Pulau Lombok bebas dari sampah plastik. Masyarakat Lombok lebih peduli terhadap lingkungan
                sekitar dengan bersama sama bahu-membahu menjaga lingkungan ini."
              </p>
      ...
      <div class="col-lg-9 col-xl-6 mt-4 mt-xl-0">
        <div class="fdb-box">
          <div class="row">
            ...
            <div class="col-md-8 mt-4 mt-md-0">
              <p class="lead">
                "Berorientasi pada pengurangan sampah plastik. Mengedukasi Masyarakat terhadap sampah plastik.
                Memberikan keuntungan yang timbal balik."
              </p>
    ...
    <div class="row text-center justify-content-center">
      <div class="col-sm-3 m-sm-auto">
        <div class="team-member">
          <img alt="image" class="img-fluid rounded-circle mg-sm-btm mg-sm-top" src="../img/yan.JPG">
          <h4>Yan Saputra</h4>
          <p>Founder</p>
        </div>
      </div>
      ...
      <div class="col-sm-3 m-sm-auto">
        <div class="team-member">
          <img alt="image" class="img-fluid rounded-circle mg-sm-btm mg-sm-top" src="../img/dhira.JPG">
          <h4>Dhira Wahyu</h4>
          <p>Founder</p>
        </div>
      </div>
      ...
      <div class="col-sm-3 m-sm-auto">
        <div class="team-member">
          <img alt="image" class="img-fluid rounded-circle mg-sm-btm mg-sm-top" src="../img/aldar.JPG">
          <h4>Aldar</h4>
          <p>Founder</p>
        </div>
      </div>
