...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-light">
    <!-- <div class="container"> -->
      <a class="navbar-brand" ></a><img src="img/logo.png" width="55px" alt="logo-pw"></a>      
  ...
  <div class="jumbotron jumbotron-fluid" style="background: url('img/jumbotron4.png'); background-repeat: no-repeat;">
    <div class="container">
      <h1 class="display-4">Dunia darurat sampah <span>plastik.</span><br>Yuk edukasi diri masalah<span> plastik!</span></h1>
              ...
              <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor
                          numquam, natus sequi blanditiis, accusamus repellendus libero.</p>
                      <hr>
                      <div class="row">
