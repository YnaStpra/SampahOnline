...
<html lang="en">
 ...
 <nav class="navbar navbar-expand-lg navbar-light">
  ...
  <!-- JUMBOTRON -->
  <div class="jumbotron jumbotron-fluid bot" style="background-image: url(../img/jumbotron2.png); background-repeat: no-repeat;">
    <div class="container">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="foto-umkm">
            <img src="img/daftar.jpg" class="img-fluid" alt="umkm-logo">
          </div>
          <h1 class="mg-sm-top">Tastura</h1>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus enim ad natus, cumque quos blanditiis voluptas exercitationem, ipsa perferendis aspernatur accusamus, autem dolores ut explicabo molestias fugit quisquam quo quasi!</p> 
          <hr>
          <ul class="social-links">
            <li>
              <p><i class="fa fa-map-marker mr-2 warna"></i>423, Apgujong-ro, Gangnam-gu, Seoul</p>  
            </li>
            <li>
              <p><i class="fa fa-user mr-2 warna"></i>Nur Izza Latifah</p>
            </li>
            <li>
              <p><i class="fa fa-envelope mr-2 warna"></i>contact@tastura.com</p>  
            </li>
          </ul>
        </div>
        </div>
        <div class="col-lg-4">
          <div class="card pd-20">
            ...
            <table>
              <tr>
                <td>
                <img src="img/logo.png" width="65px" alt="umkm-logo">
                </td>
                <td>
                  <a href="profile-umkm.html" class="warna"><h5 class="pl-10">Lombok Plastic 3R</h5></a>
                </td>
              </tr>
            </table>
          </div>
